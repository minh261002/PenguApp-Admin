...
import { getPostCatalogueById, updatePostCatalogue } from '@/services/PostCatalogueService'
import { Checkbox } from '@/components/ui/checkbox'

const EditPostCatalogue = () => {
  ...
  const fetchPostCatalogue = async () => {
    const response = await getPostCatalogueById(String(id))
  ...
  const handleEditPostCatalogue = async (data: PostCatalogue) => {
    ...
    try {
      setLoading(true)
      const response = await updatePostCatalogue(String(id), data)
  ...
  return (
    <form className='grid grid-cols-1 md:grid-cols-4 md:gap-5' onSubmit={handleSubmit(handleEditPostCatalogue)}>
...
export default EditPostCatalogue
