...
const CreateCategory = () => {
  useDocumentTitle('Thêm danh mục sản phẩm mới')
  ...
  const handleCreateCategory = async (data: PostCatalogue) => {
  ...
  return (
    <form className='grid grid-cols-1 md:grid-cols-4 md:gap-5' onSubmit={handleSubmit(handleCreateCategory)}>
      {loading ? <LoadingPage /> : null}
      <div className='col-span-3'>
        <Card className='mt-5'>
          <CardHeader className='flex-row items-center justify-between border-b mb-5'>
            <CardTitle className='font-medium'>Thêm danh mục sản phẩm mới</CardTitle>
          </CardHeader>
      ...
      <div className='col-span-1'>
        <ReturnGroup link='/category' type='create' />
